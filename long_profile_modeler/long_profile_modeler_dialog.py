...
class LongProfileModelerDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        ...
        self.pbExportDrainageAreaSlopeFigure.clicked.connect(self.onpbExportDrainageAreaSlopeFigureclicked)
    ...
    def onpbLoadSelectedChannelclicked(self):
        ...
        drainage_area_as = []
        for i in range(len(dfpath_nodes)):
            if dfpath_nodes['drainage_area_m2'][i] <= 7 * 10**6:
        ...
        #plot slope vs. drainage area in log log space
    ...
    def onpbCalculateFitclicked(self):
        ...
        self.qleKsValue.insert(ks)
        self.qleThetaValue.insert(theta)

    def onpbExportDrainageAreaSlopeFigureclicked(self):
        pass
